...
const symptoms = [
  ...
  { id: "exercise", label: "Mehr Sport und Bewegung" },
  { id: "intermittent", label: "Intervallfasten" },
  { id: "dietary", label: "Nahrungsergänzungsmittel" },
  { id: "hrt", label: "Hormonersatztherapie (HRT)" },
  { id: "remedies", label: "Pflanzliche Hausmittel" },
  { id: "calorie", label: "Kalorienzählen" },
  { id: "none", label: "Keine davon" },
];
...
const Screen10 = () => {
  ...
  const currentSelectedSymptoms = (() => {
    ...
    const saved = localStorage.getItem("screen10-symptoms");
    if (!saved) return [];
  ...
  const toggleSymptom = (value: string) => {
    setSelectedSymptoms((prev) => {
      ...
      localStorage.setItem("screen10-symptoms", JSON.stringify(next));
      return next;
    });
  };
